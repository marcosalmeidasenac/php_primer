...
<head>
    ...
    <title>PHP Primer - <?php print $title ?></title>
</head>
<body>
    <div class="container">
    ...
    <ul class="nav">
        ...
        <li class="nav-item"><a class="nav-link" href="whiledowhileloop.php">Simple While Loop</a></li>
        <li class="nav-item"><a class="nav-link" href="ifstatement.php">Simple If Statements</a></li>
